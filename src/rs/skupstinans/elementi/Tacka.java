 ...
 *         &lt;element ref="{http://www.skupstinans.rs/elementi}Podtacka" maxOccurs="unbounded" minOccurs="2"/>
 *       &lt;/choice>
...
public class Tacka implements ElementInterface {

    @XmlElementRefs({
        @XmlElementRef(name = "SkraceniNaziv", namespace = "http://www.skupstinans.rs/elementi", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Podtacka", namespace = "http://www.skupstinans.rs/elementi", type = Podtacka.class, required = false),
